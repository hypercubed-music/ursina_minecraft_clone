...
class Player(Entity):
    ...
    def update(self):
        ...
        if self.gravity:
            ...
            if ray.distance != inf:
                if math.floor(self.y - self.height - ray.distance) != self.last_fall_point:
                    self.last_fall_point = math.floor(self.y - self.height - ray.distance)
